...
import glassImagMobile from '../assets/mobile/image-stand-out.jpg'
import glassImagDesktop from '../assets/desktop/image-stand-out.jpg'
...
export const Services = () => {
  return (
    <section className="tablet:grid tablet:grid-cols-2">
      ...
      < Image
        order='order-3'
        imageMobile={glassImagMobile}
        imgDesktop={glassImagDesktop}
      />
       < Text
        order='order-4' 
